...
Shader "ProPixelizer/SRP/PixelizedWithOutlineSkew"
{
    ...
    Properties
    {
		...
		SubShader
		{
			...
			UsePass "ProPixelizer/Hidden/ProPixelizerBaseSkew/UNIVERSAL FORWARD"
			//UsePass "ProPixelizer/Hidden/ProPixelizerBase/PASS" 
			UsePass "ProPixelizer/Hidden/ProPixelizerBaseSkew/SHADOWCASTER"
			UsePass "ProPixelizer/Hidden/ProPixelizerBaseSkew/DEPTHONLY"
	...
	FallBack "ProPixelizer/Hidden/ProPixelizerBaseSkew"
}
